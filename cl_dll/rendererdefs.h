...
extern cl_dlight_t* SetupFlashlight( Vector origin, Vector angles, float time, float frametime );
...
typedef struct dlinf_s 
{
	struct cl_dlight_t* dl;
	int index;
	Vector color;
	float radius;
} dlinf_t;

extern dlinf_s g_dlinf[];

extern void DLightFollow(dlinf_s dl);
